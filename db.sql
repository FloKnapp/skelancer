...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`test`@`localhost`*/ /*!50003 TRIGGER `test`.`article_BEFORE_UPDATE` BEFORE UPDATE ON `article` FOR EACH ROW
BEGIN
SET new.updated = NOW();
END */;;
DELIMITER ;
...
INSERT INTO `category` VALUES (1,'Development'),(2,'Showcase');
